Project description:
This project is the final project, which includes hw4 project and the analysis based on the data collected in hw4.
I love parks, so I decide to implement a ranking system which ranks the parks in the United States and recommended
the top 5 to the user.
In this project, I collected information about parks. More specifically I focused on 5 different data.
...
This project collections three types of data.
...
installation simply fails. Therefore, I uncommented that part in my code to make sure graders can install everything
and execute the scripts without any error.